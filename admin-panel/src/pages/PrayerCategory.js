          ...
          <TableBody>
            {categories.map((cat) => (
              <TableRow key={cat.id}>
                ...
                <TableCell>
                  <IconButton aria-label="edit category" onClick={() => handleEdit(cat)}><EditIcon /></IconButton>
                  <IconButton aria-label="delete category" onClick={() => handleDelete(cat.id)}><DeleteIcon /></IconButton>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
